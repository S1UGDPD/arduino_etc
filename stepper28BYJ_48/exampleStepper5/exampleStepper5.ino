...
//////////////////////////////////////////////////////////////////////////////
void loop(){
  motorSpeed = 3;  //scale potValue to be useful for motor

  // full circle demonstration calibrated
  for(int n = 0; n < 514; n++) // good
    clockwise();
  ...
  // half circule demonstration calibrated
  for(int i = 0; i < 257; i++) // good
